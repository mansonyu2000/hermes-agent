...
- [ ] Link test strategy to ZenTao story via `zentao story comment`
- [ ] Report test results to ZenTao task via `zentao task comment`
- [ ] Notify team of regression suite results via MIM
