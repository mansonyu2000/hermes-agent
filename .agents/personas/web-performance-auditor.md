...
- [ ] Create ZenTao task for performance regression via `zentao task create`
- [ ] Attach performance report to ZenTao story
- [ ] Share performance scorecard via MIM with team
